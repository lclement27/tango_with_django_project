...
def index(request):
    ...
    # Order the categories by the numberr og likes in desceding Ordere
...
def show_category(request, category_name_slug):
    ...
    try:
        ...
        # The .get() method returns one model instance or raises an excpetion
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # Now we hash the password with th eset_password method.
            # Once hashed, we can update teh user object.
            ...
            # Update out variable to indicate that the tamplate registration
            # was successful
            registered = True
        else:
        ...
        # These forms will blank, ready for user input.
        user_form = UserForm()
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        # returns None if the value does not exist, while the
        # request.POST['<variable>'] will raise a KeyError exception
        username = request.POST.get('username')
        password = request.POST.get('password')

        # Use Django's machinery to attempt to se if the username/password
        # combination is valid - a User object is returned it is.
